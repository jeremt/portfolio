...
const Icon = styled(Image)<{selected: boolean}>`
    object-fit: cover;
    width: 30px;
    height: 30px;
    border-radius: 5px;
            ...
            <Div className="content">
                <LeftPanel width="60%" direction="y">
                    <Div width="100%" align="center" distribute="center">
                        <Image className="preview" src={projects[selectedProject].image} width={512} height={288} alt={projects[selectedProject].name} />
                    </Div>
                    <Div padding="5px 10px" align="center" spacing="5px">
                        <Icon
                            ...
                            src="/assets/images/project-jsjourney.png"
                            alt="hello"
                            width={512}
                            height={288}
                        />
                        <Icon
                            ...
                            src="/assets/images/project-voltapp.png"
                            alt="hello"
                            width={512}
                            height={288}
                        />
